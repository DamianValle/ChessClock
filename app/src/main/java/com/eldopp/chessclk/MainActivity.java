...
public class MainActivity extends AppCompatActivity {
    ...
    public void showRateMsg() {
        try{
            ...
            intent.setData(Uri.parse("market://details?id=com.eldopp.chessclk"));
            startActivity(intent);
            ...
            Toast.makeText(getApplicationContext(), "Please consider giving us positive feedback.", Toast.LENGTH_LONG).show();
            Intent intent = new Intent(Intent.ACTION_VIEW);
            intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.eldopp.chessclk"));
            startActivity(intent);
        }
